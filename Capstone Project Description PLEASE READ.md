...
### **Project Phases:**
  ...
  - **Build Phase #1:** [ERP Customizations with D365 Business Central AL](#build-phase-1-erp-customizations-in-d365-business-central-al)
  - **Build Phase #2:** [Orchestrating Dataflows with Power Automate and Sharepoint](#build-phase-2-orchestrating-dataflows-with-power-automate-and-sharepoint)
